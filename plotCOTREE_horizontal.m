...
function iDrawLegend(ax)
    ...
    patch(ax, Xleg, Yleg, colorleg, 'HitTest', 'off', 'PickableParts', 'none');

    text(ax, 0.79, 0.965, 'Normal State', 'FontSize', 11, ...
        'HitTest', 'off', 'PickableParts', 'none');
    text(ax, 0.79, 0.925, 'Terminal State', 'FontSize', 11, ...
        'HitTest', 'off', 'PickableParts', 'none');
    text(ax, 0.79, 0.885, 'Duplicate State', 'FontSize', 11, ...
        'HitTest', 'off', 'PickableParts', 'none');
end
